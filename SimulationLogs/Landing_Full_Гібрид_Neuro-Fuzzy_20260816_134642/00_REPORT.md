...
| Промах (pad) | 18,38 м | < 25 м | ✅ |
| Бічна швидкість |Vh| | 0,89 м/с | < 5 | ✅ |
| Залишок палива | 6253,5 кг | — | ✅ |
| Час польоту | 63,4 с | — | ✅ |
| Макс. висота | 1400 м | — | ✅ |
| SuccessScore | 85,1 / 100 | вище = краще | ✅ |
...
**Каталог:** `SimulationLogs/Landing_Full_Гібрид_Neuro-Fuzzy_20260816_134642/`
...
• Нахил: 0,0°  (норма < 7°)
• Промах: 18,4 м  (норма < 25 м)
• Бічна V: 0,9 м/с  (норма < 5)
• Оцінка: 85 / 100
```
