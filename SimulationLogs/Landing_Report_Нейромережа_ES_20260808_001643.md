...
|----------|----------|-------|--------|
| Швидкість приземлення |Vy| | 0,67 м/с | < 3,5 | ✅ |
| Нахил корпусу | 0,00° | < 7° | ✅ |
| Промах (pad) | 10,42 м | < 25 м | ✅ |
| Бічна швидкість |Vh| | 0,45 м/с | < 5 | ✅ |
| Залишок палива | 7459,4 кг | — | ✅ |
| Час польоту | 51,9 с | — | ✅ |
| Макс. висота | 1400 м | — | ✅ |
| SuccessScore | 89,6 / 100 | вище = краще | ✅ |
...
**Каталог:** `SimulationLogs/Landing_Full_Нейромережа_ES_20260808_001643/`
...
• Нахил: 0,0°  (норма < 7°)
• Промах: 10,4 м  (норма < 25 м)
• Бічна V: 0,5 м/с  (норма < 5)
• Оцінка: 90 / 100
```
