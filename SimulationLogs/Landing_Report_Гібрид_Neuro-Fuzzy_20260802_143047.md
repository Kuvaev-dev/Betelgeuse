...
|----------|----------|-------|--------|
| Швидкість приземлення |Vy| | 176,93 м/с | < 3,5 | ❌ |
| Нахил корпусу | 112,11° | < 7° | ❌ |
| Промах (pad) | 6,64 м | < 25 м | ✅ |
| Бічна швидкість |Vh| | 4,82 м/с | < 5 | ✅ |
| Залишок палива | 13084,5 кг | — | ✅ |
| Час польоту | 16,1 с | — | ✅ |
| Макс. висота | 1800 м | — | ✅ |
| SuccessScore | 30,6 / 100 | вище = краще | ✅ |
...
**Каталог:** `SimulationLogs/Landing_Full_Гібрид_Neuro-Fuzzy_20260802_143047/`
