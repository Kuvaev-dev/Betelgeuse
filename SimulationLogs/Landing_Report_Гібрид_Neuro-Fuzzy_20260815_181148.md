...
| Промах (pad) | 19,92 м | < 25 м | ✅ |
| Бічна швидкість |Vh| | 0,96 м/с | < 5 | ✅ |
| Залишок палива | 6072,4 кг | — | ✅ |
| Час польоту | 65,1 с | — | ✅ |
| Макс. висота | 1400 м | — | ✅ |
| SuccessScore | 84,3 / 100 | вище = краще | ✅ |
...
**Каталог:** `SimulationLogs/Landing_Full_Гібрид_Neuro-Fuzzy_20260815_181148/`
...
• Нахил: 0,0°  (норма < 7°)
• Промах: 19,9 м  (норма < 25 м)
• Бічна V: 1,0 м/с  (норма < 5)
• Оцінка: 84 / 100
```
