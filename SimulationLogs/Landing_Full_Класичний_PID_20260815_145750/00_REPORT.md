...
|----------|----------|-------|--------|
| Швидкість приземлення |Vy| | 0,36 м/с | < 3,5 | ✅ |
| Нахил корпусу | 0,00° | < 7° | ✅ |
| Промах (pad) | 6,44 м | < 25 м | ✅ |
| Бічна швидкість |Vh| | 0,17 м/с | < 5 | ✅ |
| Залишок палива | 7232,3 кг | — | ✅ |
| Час польоту | 54,0 с | — | ✅ |
| Макс. висота | 1400 м | — | ✅ |
| SuccessScore | 94,1 / 100 | вище = краще | ✅ |
...
**Каталог:** `SimulationLogs/Landing_Full_Класичний_PID_20260815_145750/`
...
• Швидкість: 0,4 м/с  (норма < 3,5)
• Нахил: 0,0°  (норма < 7°)
• Промах: 6,4 м  (норма < 25 м)
• Бічна V: 0,2 м/с  (норма < 5)
• Оцінка: 94 / 100
```
