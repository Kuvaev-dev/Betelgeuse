...
public static class UILocale
{
    ...
    static readonly Dictionary<string, Pair> Table = new()
    {
        ...
        ["tip"] = new("1-4 алгоритм, Space старт, Esc стоп, F/T/C/R камера, E експорт, H панелі",
            "1-4 algorithm, Space start, Esc stop, F/T/C/R camera, E export, H panels"),
        ["bottom"] = new("Успіх: |Vy|<3.5 · нахил<7° · промах<25м · |Vh|<5  ·  Space старт · Esc стоп · H панелі · E експорт",
            "Success: |Vy|<3.5 · tilt<7° · miss<25m · |Vh|<5  ·  Space start · Esc stop · H panels · E export"),
