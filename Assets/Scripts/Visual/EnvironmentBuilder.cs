...
public static class EnvironmentBuilder
{
    ...
    public static IEnumerator BuildRoutine()
    {
        ...
        Splash(0.78f, "Середовище: готово", "Environment: done");
        yield return null;
    }
    ...
    static IEnumerator BuildEarthSurfaceRoutine(Transform parent)
    {
        ...
        Splash(0.71f, "Природа: готово", "Nature: done");
        yield return null;
    ...
    static void BuildLandingPad(Transform parent)
    {
        ...
        // 128 сегментів — силует pad ≈ ідеальне коло (не 20-gon Unity primitive)
